    ...
    return (
      <div className="App">
        ...
        <Switch>
          ...
          <Route
            exact
            path="/support-an-artist-project"
          ...
          <Route
            ...
            render={(props) => (
              <GalleryProfileHooks
                ...
                changeGalleryName={this.changeGalleryName}
          ...
          <Route
            exact
            path="/collector/acquisitions"
            render={(props) => (
              <CollectorAcquisitions2
                setUser={this.setUser}
                user={this.state.user}
                collectorName={this.state.collectorName}
                {...props}
          ...
          <Route
            ...
            render={(props) => (
              <CollectorProfile
                setUser={this.setUser}
                changeCollectorName={this.changeCollectorName}
                user={this.state.user}
                {...props}
              />
            )}
