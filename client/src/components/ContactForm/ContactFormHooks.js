    ...
    <div className="contactContainer">
      ...
      <div className="formContainer">
        <Tabs className="tabContact">
          ...
          <TabPanel>
            <h2>
              GET IN TOUCH WITH OUR TEAM REGARDING ANY QUESTIONS YOU MIGHT HAVE
              WITH OUR ACTIVITIES
            </h2>
            <form id="contactForm" onSubmit={submitEmail} method="POST">
                ...
                <div className="radio-toolbar">
                  <div>
                    <input
                      ...
                      id="radioSupport"
                      type="radio"
                      value="SUPPORT AN ARTIST PROJECT"
                      checked={checkedOption === "SUPPORT AN ARTIST PROJECT"}
                    ></input>
                    <label htmlFor="radioSupport">
                  ...
                  <div>
                    <input
                      ...
                      checked={checkedOption === "PERSONAL ADVISOR"}
                    ></input>
                  ...
                  <div>
                    <input
                      ...
                      type="radio"
                      id="radioSpecial"
                      value="SPECIAL SOURCING"
                      checked={checkedOption === "SPECIAL SOURCING"}
                    ></input>
                  ...
                  <div>
                    <input
                      ...
                      type="radio"
                      id="radioArtist"
                      value="ARTIST OPEN CALL"
                      checked={checkedOption === "ARTIST OPEN CALL"}
                    ></input>
              ...
              <div id="inquireAndButton">
                ...
                <div className="contactFooter">
                  ...
                  <Link to="mailto:info@ora-arts.com">
                    <h3 className="contact-email">INFO@ORA-ARTS.COM</h3>
                  </Link>
