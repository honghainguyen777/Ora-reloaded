          ...
          <div className="container-profile-content">
            ...
            <div className="gallery-profile">
              <div className="gallery-content">
                ...
                <div className="input-block">
                  ...
                  <div className="input-container-half">
                    ...
                    <input
                      ...
                      className="input-hidden"
                      placeholder="Your position at the gallery"
                    ></input>
                  </div>
                </div>
                ...
                <div className="input-block">
                  ...
                  <div className="input-container-full">
                    ...
                    <input
                      ...
                      className="input-hidden"
                      placeholder="Enter the address of the gallery"
                    ></input>
                  </div>
                </div>
                      ...
                      <div className="website-box">
                        ...
                        <div className="input-lable-left">
                          <input
                            ...
                            className="input-hidden"
                            placeholder="www.gallerieneu.com"
                          ></input>
                        </div>
                      </div>
                    </div>
                ...
                <button className="btn-edit save-change space-top">
                  SAVE CHANGES
                </button>
              </div>
            </div>
