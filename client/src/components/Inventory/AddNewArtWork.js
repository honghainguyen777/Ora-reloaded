...
const AddNewArtWork = (props) => {
  ...
  const clickedImageHandler = (index) => {
    if (index > data.images.length - 1) {
      setActiveImage(
        URL.createObjectURL(uploadedImages[index - data.images.length])
      );
    } else {
  ...
  const generateThumbnails = () => {
    if (!data.images.length && !uploadedImages.length) {
      return (
        <img src={image} alt="artwork" className="artwork-detail-thumbnail" />
      );
    }
    let images = [];
          ...
          <div className="gallery-profile">
            <div className="gallery-content">
              <div className="profile-title">
                <hr />
                <span className="title-text">ADD A NEW ARTWORK</span>
              </div>
              <div className="artwork-detail">
                      ...
                      {isEditMode ? (
                        <>
                          <input
                            ...
                            id="inventory-file"
                            type="file"
                            className="inventory-input-hidden"
                          />
                          <label
                            htmlFor="inventory-file"
                            className="inventory-btn-image"
                          >
                            ADD IMAGE
                          </label>
                        </>
                ...
                <div className="artwork-detail-info">
                  <div className="artwork-detail-info-field">
                    <div className="detail-info-label inventory-artist">
                      ARTIST{" "}
                    </div>
                  ...
                  <div className="artwork-detail-info-field">
                    ...
                    <div className="detail-info-field">
                      {isEditMode ? (
                        <input
                          onChange={onChange}
                          value={data.materialsAndTechnique}
                          name="materialsAndTechnique"
                          type="text"
                          placeholder="Chalk, Charcoal, Underpainting"
                        />
                      ) : (
                  ...
                  <div className="artwork-detail-info-field">
                    <div className="detail-info-label">
                      Dimensions <br /> (length x height x width in mm)
                    </div>
                      ...
                      {isEditMode ? (
                        <>
                          <input
                            ...
                            name="height"
                            type="number"
                            className="detail-info-field-small"
                            placeholder="Height"
                          />
                          <input
                            onChange={onChange}
                        ...
                        <span>
                          {data.height}mm x {data.length}mm x {data.width}mm
                        </span>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="artwork-detail-info-field">
                    ...
                    <div className="detail-info-field">
                      {isEditMode ? (
                        <input
                          type="text"
                          placeholder="Type in number to enter"
                        />
                      ) : (
                        <span>{"Unknown"}</span>
                      )}
              ...
              <div className="inventory-btn-bottom">
                <button
                  onClick={() => props.history.push("/gallery/inventory")}
                  className="btn-back-inventory"
                >
                ...
                {isEditMode ? (
                  <button
                    ...
                    className="btn-edit save-change"
                  >
                    SAVE CHANGES
                  </button>
                ) : null}
