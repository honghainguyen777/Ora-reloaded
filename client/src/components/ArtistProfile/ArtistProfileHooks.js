    ...
    <>
      ...
      <div className="myArtists">
        ...
        <div className="artistsContainer">
          ...
          <div className="artistsInfo">
              ...
              <div className="right">
                <div className="image-container" id="artistImgC">
                  <img
                    ...
                    alt={image ? data.name.split(".")[0] : "artistImage"}
                  />
                  {isEditMode ? (
                    <>
                      <input
                        type={isViewMode && !isEditMode ? "hidden" : "file"}
                        id="file"
            ...
            <div className="topInfo">
              <div className="left">
                <div className="artist-input">
                  <span className="inputLabel">
                    UNIQUE ARTWORKS PRICE RANGE <br /> (MIN MAX IN K€) /{" "}
                  </span>
                  {isEditMode ? (
                    <>
                      <input
                        ...
                        name="artwork_min"
                        onChange={onChange}
                        value={data.artwork_min}
                        className="inputClear min"
                        placeholder="3"
                      ></input>
                      <span>-</span>
                      <input
                        ...
                        name="artwork_max"
                        onChange={onChange}
                        value={data.artwork_max}
                        className="inputClear min"
                        placeholder="3"
                      ></input>
                      <span className="textkEur">K/€</span>
                    </>
                  ) : (
                    <span>
                      {" "}
                      {data.artwork_min} K - {data.artwork_max} K{" "}
                    </span>
                  )}
                </div>
              </div>
              <div className="right">
                <div className="artist-input">
                  <span className="inputLabel">
                    EDITIONS AND MULTIPLIES <br /> (MIN MAX IN k€)/{" "}
                  </span>
                  {isEditMode ? (
                    <>
                      <input
                    ...
                    <span>
                      {" "}
                      {data.editions_min} K - {data.editions_max} K{" "}
                    </span>
                  )}
                </div>
              </div>
          ...
          {isEditMode ? (
            <button className="btnBlack" onClick={submitHandler}>
              {" "}
              SAVE ARTIST{" "}
            </button>
          ) : null}
